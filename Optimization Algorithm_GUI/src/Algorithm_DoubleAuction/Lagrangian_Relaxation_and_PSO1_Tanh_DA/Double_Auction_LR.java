...
public class Double_Auction_LR extends Double_Auction_LR_and_PSO1_Tanh{
	...
	public static void main() throws IOException {
		...
		L =  Read_LR_and_PSO1_Tanh_Parameter.L();
		c =  Read_LR_and_PSO1_Tanh_Parameter.c();
		Print = Read_LR_and_PSO1_Tanh_Parameter.Print();
		...
		double fintestN_1=0;
		//System.out.println(Math.abs(Functions.L(X, Y)-fintestN_1)/Math.abs(fintestN_1));
		 while ( Functions.L(X, Y)-fintestN_1 /Functions.L(X, Y)> threshold) {
	/*	for(int t=0;t<10;t++){	*/
