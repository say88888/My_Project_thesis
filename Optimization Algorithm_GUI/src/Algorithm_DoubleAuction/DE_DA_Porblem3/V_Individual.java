...
public class V_Individual extends Double_Auction_DE_Problem3 {
	...
	public void XpreviousIndividual() {
		for (int i = 0; i < Vxsize(); i++) {
			 Vx[i] =DE_Read_Write_txt.random_generate_or_read2(Execution_Mode,Read_Seller_Price_Parameter.top()+1) ;
		}
