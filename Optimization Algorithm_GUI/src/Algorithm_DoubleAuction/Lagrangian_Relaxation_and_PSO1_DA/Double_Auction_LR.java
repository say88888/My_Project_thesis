package Algorithm_DoubleAuction.Lagrangian_Relaxation_and_PSO1_DA;
...
public class Double_Auction_LR extends Double_Auction_LR_and_PSO1{
	...
	public static void main() throws IOException {
		...
		L =  Read_LR_and_PSO1_Parameter.L();
		c =  Read_LR_and_PSO1_Parameter.c();
		Print = Read_LR_and_PSO1_Parameter.Print();
		...
		//System.out.println(Math.abs(Functions.L(X, Y)-fintestN_1)/Math.abs(fintestN_1));
		 while ( Math.abs(Functions.L(X, Y)-fintestN_1 /Functions.L(X, Y))> threshold) {
	/*	for(int t=0;t<10;t++){	*/
