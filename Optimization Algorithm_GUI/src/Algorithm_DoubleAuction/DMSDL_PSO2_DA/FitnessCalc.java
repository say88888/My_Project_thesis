...
public class FitnessCalc extends DMSDL_PSO2 {
	...
	static double getGVFitness(GV_Individual individual) {
		 double fitness = 0;
		  int c = 0;
			...
			for (int i = 0; i < N; i++)
				for (int j = 0; j < Y[i].length; j++)
					Y[i][j] = individual.getGVy(c++);

			for (int i = 0; i < I; i++)
				for (int j = 0; j < X[i].length; j++)
					X[i][j] = individual.getGVx(b++);
	...
	static double getUFitness(U_Individual individual) {
		 double fitness = 0;
		  int c = 0;
			...
			for (int i = 0; i < N; i++)
				for (int j = 0; j < Y[i].length; j++)
					Y[i][j] = individual.getUy(c++);

			for (int i = 0; i < I; i++)
				for (int j = 0; j < X[i].length; j++)
					X[i][j] = individual.getUx(b++);
