...
public class Double_Auction_PSO1_Tanh {
	...
	public static void main() throws IOException {
		...
		if (GUI.main.getmethod() != 2) {
			...
			System.out.print("Generation: " + generationCount
					...
					+ " F1(x,y) Fittest: " + myPop.getFittest().getFitness1()
					+ " Y=");
			...
			Output_Result.PSO1_Tanh(Y, X, Fittest, Fittest_Iter, T_total_time,
						...
						for (c2 = Read_PSO_Batch_Parameter.lowc2(); c2 <= Read_PSO_Batch_Parameter
							...
							System.out
									.println("執行時間扣除寫檔時間  T_net="
											...
											+ "ms");
							CheckConstraint.CheckConstraints();
							Output_Result.savePSO1_Tanh_Batch_Parameter(n,
									populationSize, w, c1, c2, Vmax,
									Execution_Mode, Print_Mode, Write_Mode,
									threshold);
							Output_Result.PSO1_Tanh_Batch(n, Y, X, Fittest,
			...
			System.err.println(Fittest_Batch);
			System.err.println(k);
			// Output_Result.PSO1_Batch_best(Y_Batch, X_Batch, Fittest_Batch,
			// generationCount_Batch,Time_Batch);
			// Output_Result.savePSO1_Batch_Parameter(n,populationSize_Batch,w_Batch,c1_Batch,c2_Batch,
