...
public class Double_Auction_PSO1_P {
	...
	public static void main() throws IOException {
		...
		if (GUI.main.getmethod() != 2) {
			...
			Output_Result.PSO1_P(Y, X, Fittest, Fittest_Iter, T_total_time,
			...
			// Output_Result.savePSO1_P_Batch_Parameter(n,populationSize_Batch,w_Batch,c1_Batch,c2_Batch,
