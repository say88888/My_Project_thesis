...
public class Double_Auction_NSDE_Problem3 {
...
//	public static ArrayList<Double> successfulCR = new ArrayList<Double>();
	...
	public static void main() throws IOException {
		...
		F = DE_Read_Write_txt.random_generate_or_read6(Execution_Mode,2);
		CR = 0.5;
		R=DE_Read_Write_txt.R();
	...
	//	CheckConstraint.CheckConstraints();
		Output_Result.NSDE_DA_Problem3(GY, GX, Fittest, Fittest_Iter, T_total_time,
