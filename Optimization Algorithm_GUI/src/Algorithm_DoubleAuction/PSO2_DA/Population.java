...
public class Population extends Double_Auction_PSO2 {
	...
	public Population(int populationSize, boolean initialise) {
		...
		if (initialise) {
			...
			newGIndividual.rsglobalIndividual();
			newGIndividual.rbglobalIndividual();
			newGIndividual.rglobalIndividual();
			saveG_Individual(newGIndividual);

			E_Individual newEIndividual = new E_Individual();
			newEIndividual.XglobalIndividual();
			newEIndividual.YglobalIndividual();
			newEIndividual.rsglobalIndividual();
			newEIndividual.rbglobalIndividual();
			newEIndividual.rglobalIndividual();
			...
			for (int i = 0; i < size(); i++) {
				...
				newIndividual.rsgenerateIndividual();
				newIndividual.rbgenerateIndividual();
				newIndividual.rgenerateIndividual();
				saveIndividual(i, newIndividual);

				P_Individual newPIndividual = new P_Individual();
				newPIndividual.XpreviousIndividual();
				newPIndividual.YpreviousIndividual();
				newPIndividual.rspreviousIndividual();
				newPIndividual.rbpreviousIndividual();
				newPIndividual.rpreviousIndividual();
				...
				newVIndividual.rsvelocityIndividual();
				newVIndividual.rbvelocityIndividual();
				newVIndividual.rvelocityIndividual();
	...
	public G_Individual getFittest() {
		...
		/*
		 * for (int i = 0; i < size(); i++) { if (fittest.getFitness() <=
		 * getG_Individual(i).getFitness()) { fittest = getG_Individual(i); } }
		 */
		return fittest;
	}
