...
public class Double_Auction_PSO2_P {
	...
	public static void main() throws IOException {
		...
		Original_temp_variables_Global_best_Y.add(Y1);
			...
			Output_Result.PSO2_P(Y, X, Fittest, Fittest_Iter, T_total_time,
			...
			// Output_Result.savePSO2_P_Batch_Parameter(populationSize_Batch,w_Batch,c1_Batch,c2_Batch,
