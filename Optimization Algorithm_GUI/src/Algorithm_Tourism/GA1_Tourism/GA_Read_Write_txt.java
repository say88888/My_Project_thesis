...
public class GA_Read_Write_txt extends GA1_Tourism {
	...
	public static void read_GA_Parameters()throws IOException{
		...
		int d=0;
				...
				String line1;
				FileReader GARfr = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\GA_Parameter\\GA1\\Tourism_Penalty.txt");
		        ...
		        R6=Integer.parseInt(GAR[5]);
		        R7=Integer.parseInt(GAR[6]);
