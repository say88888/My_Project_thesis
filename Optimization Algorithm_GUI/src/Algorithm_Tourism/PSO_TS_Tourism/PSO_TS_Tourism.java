	...
	public static void main() throws IOException {
		...
		//	PSO_Data_print.print2(myPop, Print_Mode);
			...
			for (int iter = 0; iter < Iteration; iter++) {
				if ((Math.abs(myPop.getFittest().getFitness1()
						- myPopFitnessN_1)
						/ Math.abs(myPopFitnessN_1) > threshold)
						|| constraint(Xa,Xh,Xt, Y) == false) {
		...
		//	Print_input.main(Print_Mode);
			Output_Result.PSO_TS_Tourism(Y, Xa,Xh,Xt, Fittest, generationCount, T_total_time,
