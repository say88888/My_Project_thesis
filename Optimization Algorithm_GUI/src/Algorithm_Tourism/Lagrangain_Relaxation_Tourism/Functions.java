package Algorithm_Tourism.Lagrangain_Relaxation_Tourism;
...
public class Functions extends LR_Tourism {
	...
	public static int[][] Xa(int[][] X ) {
		
		for(int i=0;i<Read_Tourism.Ia();i++)
			for(int j=0;j<Read_Tourism.Ja(i);j++){
				double fitness =0;
				fitness+=Omega_1*(-Read_Tourism.Paij(i, j)+(Read_Tourism.Tsm()*Read_Tourism.Paij(i, j)));
				fitness+=Omega_2;
				for(int k=0;k<Read_Tourism.K();k++)
					fitness+=Lambda1[k]*Read_Tourism.qijk(i, j, k);
				fitness-=Lambda4*Read_Tourism.Paij(i, j);
				for(int k=0;k<Read_Tourism.K();k++)
					fitness-=Lambda5[i][k]*Read_Tourism.qijk(i, j, k);
	...
	public static int[][] Xh(int[][] X ) {
		
		for(int i=0;i<Read_Tourism.Ih();i++)
			for(int j=0;j<Read_Tourism.Jh(i);j++){
				double fitness =0;
				fitness+=Omega_1*(-Read_Tourism.Phij(i, j)+(Read_Tourism.Tsm()*Read_Tourism.Phij(i, j)));
				fitness+=Omega_2;
				for(int k=0;k<Read_Tourism.K();k++)
					for(int m=0;m<Read_Tourism.M();m++)
						fitness+=Lambda2[k]*Read_Tourism.DELTA(k, m)*Read_Tourism.uijm(i, j, m);
				fitness-=Lambda4*Read_Tourism.Phij(i, j);
				for(int m=0;m<Read_Tourism.M();m++)
					fitness-=Lambda6[i][m]*Read_Tourism.uijm(i, j, m);
	...
	public static int[][] Xt(int[][] X ) {
		
		for(int i=0;i<Read_Tourism.It();i++)
			for(int j=0;j<Read_Tourism.Jt(i);j++){
				double fitness =0;
				fitness+=Omega_1*(-Read_Tourism.Ptij(i, j)+(Read_Tourism.Tsm()*Read_Tourism.Ptij(i, j)));
				fitness+=Omega_2;
				for(int k=0;k<Read_Tourism.K();k++)
					for(int t=0;t<Read_Tourism.T();t++)
						fitness+=Lambda3[k]*Read_Tourism.PI(k, t)*Read_Tourism.tijt(i, j, t);
				fitness-=Lambda4*Read_Tourism.Ptij(i, j);
				for(int t=0;t<Read_Tourism.T();t++)
					fitness-=Lambda7[i][t]*Read_Tourism.tijt(i, j, t);
...
public static int[][] Y(int[][] Y ) {
		...
		for(int i=0;i<Read_Tourism.N();i++)
			for(int j=0;j<Read_Tourism.H(i);j++){
				double fitness =0;
				fitness+=Omega_1*(Read_Tourism.Phij(i, j)+(Read_Tourism.Tbm()*Read_Tourism.Phij(i, j)));
				fitness+=Omega_2;
				for(int k=0;k<Read_Tourism.K();k++)
					fitness-=Lambda1[k]*Read_Tourism.dnhk(i, j, k);
				for(int k=0;k<Read_Tourism.K();k++)
					for(int m=0;m<Read_Tourism.M();m++)
						fitness-=Lambda2[k]*Read_Tourism.dnhk(i, j, k)*Read_Tourism.DELTA(k, m);
				for(int k=0;k<Read_Tourism.K();k++)
					for(int t=0;t<Read_Tourism.T();t++)
						fitness-=Lambda3[k]*Read_Tourism.dnhk(i, j, k)*Read_Tourism.PI(k, t);
				fitness+=Lambda4*Read_Tourism.Pbnh(i, j);
