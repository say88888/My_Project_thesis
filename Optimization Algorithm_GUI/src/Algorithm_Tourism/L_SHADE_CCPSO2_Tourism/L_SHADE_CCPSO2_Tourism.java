...
public class L_SHADE_CCPSO2_Tourism {
	...
	public static void main() throws IOException {
		...
		for (int iter = 0; iter < Iteration; iter++) {
			// System.out.println("  F2(x,y) Fittest: = "+
			// myPop.getFittest().getFitness1()
			// +"   F2(x,y) Fittest 成長值 = "+Math.abs(myPop.getFittest().getFitness1()-myPopFitnessN_1)/Math.abs(myPopFitnessN_1)+"     限制式 : "
			// + constraint(X, Y));
			SAlpha1.clear();
			SAlpha2.clear();
			SAlpha3.clear();
