...
public class Function extends DE_Real_POP_Tourism{
...
*/
	 static int select_strategy() {
			...
			if(Select_Algorithm_Type.equals("DE_Real_POP")){
			...
			else if(Select_Algorithm_Type.equals("DE_strategy1_Real_POP")){
				System.out.println("DE_strategy1_Real_POP");
				strategy = 1;
			}
			else if(Select_Algorithm_Type.equals("DE_strategy2_Real_POP")){
				System.out.println("DE_strategy2_Real_POP");
				strategy = 2;
			}
			else if(Select_Algorithm_Type.equals("DE_strategy3_Real_POP")){
				System.out.println("DE_strategy3_Real_POP");
				strategy = 3;
			}
			else if(Select_Algorithm_Type.equals("DE_strategy4_Real_POP")){
				System.out.println("DE_strategy4_Real_POP");
				strategy = 4;
			}
			else if(Select_Algorithm_Type.equals("DE_strategy5_Real_POP")){
				System.out.println("DE_strategy5_Real_POP");
				strategy = 5;
			}
			else if(Select_Algorithm_Type.equals("DE_strategy6_Real_POP")){
