...
public class LRPSO_Tourism {
	...
	public static void main( ) throws IOException {
		...
		System.out.println(Functions.L(Xa,Xh,Xt, Y));
		...
		//System.out.print(" "+constraint(Xa,Xh,Xt, Y));
		System.out.println();
	...
	//	CheckConstraint.CheckConstraints(X,Y);
		...
		Output_Result.LRPSO_Tourism(Y, Xa,Xh,Xt, Fittest, generationCount,T_total_time, (T_total_time-time_write_to_TXT) );
