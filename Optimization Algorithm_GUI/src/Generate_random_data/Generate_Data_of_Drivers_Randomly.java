...
public class Generate_Data_of_Drivers_Randomly {
	...
	public	static void Generate_Data_of_Drivers_Randomly() throws IOException
	{
		...
		for(i=0;i<D;i++)
		{
			...
			time=(int) Read_distance.getDistancetime(D_m[i],D_n[i]);
			D_F_A_Time[i]=Calculate_the_function.randomtime((Read_Generate_random.DTimeRandon(3)+time+10),(Read_Generate_random.DTimeRandon(2)+time+10));    //司機到達目的地時間
			D_S_A_Time[i]=Calculate_the_function.randomtime((Read_Generate_random.DTimeRandon(3)+time+20),(Read_Generate_random.DTimeRandon(2)+time+20));    //司機延遲到達目的地時間
