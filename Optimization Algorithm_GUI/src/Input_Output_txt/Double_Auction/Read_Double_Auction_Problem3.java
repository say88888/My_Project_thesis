...
public class Read_Double_Auction_Problem3 {
	...
	public static void main() throws IOException {
		...
		K = Integer.parseInt(Par[N + 2]);
		//System.out.println(K);
		Tbm = Double.parseDouble(Par[N + 3]);
		//System.out.println(Tbm);
		Tsm = Double.parseDouble(Par[N + 4]);
...
/*		System.out.println("Parameter:");
		...
		for(int i=0;i<N;i++){
			for(int j=0;j<H[i];j++){
				for(int k=0;k<K;k++)
					System.out.print(dnhk[i][j][k]+" ");
				System.out.println(Pnh[i][j]);
			}
		}
		*/
