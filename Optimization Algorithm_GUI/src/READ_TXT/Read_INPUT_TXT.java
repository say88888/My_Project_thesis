...
//定義投標資料-----------------------------------------------
	...
	try {
		FileReader PBr = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random\\passenger_initial_itinerary");
	...
	try {
		FileReader PBr1 = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random\\driver_initial_itinerary");
	...
	//--------------------------------讀取CarData--------------------------------
	try {
		FileReader PBr2 = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random\\car_data");
