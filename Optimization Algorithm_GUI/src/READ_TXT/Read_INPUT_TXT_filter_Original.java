...
public class Read_INPUT_TXT_filter_Original {	
...
//定義投標資料-----------------------------------------------
	...
	try {
		FileReader PBr = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random_filter_original\\passenger_initial_itinerary");
	...
	try {
		FileReader PBr1 = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random_filter_original\\driver_initial_itinerary");
	...
	//--------------------------------讀取CarData--------------------------------
	try {
		FileReader PBr2 = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random_filter_original\\car_data");
	...
	//--------------------------------讀取 passenger_data--------------------------------
	try {
		FileReader PBr3 = new FileReader(I_Set_Paths_for_Current_Simulation_Example.path()+"\\SQL_input_random_filter_original\\passenger_data");
