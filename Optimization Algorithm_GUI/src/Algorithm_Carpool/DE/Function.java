...
public class Function extends DE{
	...
	//	successfulCR = new ArrayList<Double>();
	 ...
	 static int select_strategy() {
			...
			if(Select_Algorithm_Type.equals("DE_Carpool")){
			...
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy1")){
				System.out.println("DE_Carpool_strategy1");
				strategy = 1;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy2")){
				System.out.println("DE_Carpool_strategy2");
				strategy = 2;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy3")){
				System.out.println("DE_Carpool_strategy3");
				strategy = 3;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy4")){
				System.out.println("DE_Carpool_strategy4");
				strategy = 4;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy5")){
				System.out.println("DE_Carpool_strategy5");
				strategy = 5;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy6")){
