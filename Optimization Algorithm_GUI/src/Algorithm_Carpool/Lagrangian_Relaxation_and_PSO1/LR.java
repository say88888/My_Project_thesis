...
public class LR extends LR_and_PSO1{
	...
	public static void main( ) throws IOException {
		...
		Output_Result.LR(Y, X, Functions.L(X, Y), generationCount, totalendTime-totalstartTime);
		 Output_Result.LR_XY_Lambda(Y, X, Functions.L(X, Y), generationCount, totalendTime-totalstartTime,Lambda1,Lambda2,Lambda3,Lambda4);
	}
