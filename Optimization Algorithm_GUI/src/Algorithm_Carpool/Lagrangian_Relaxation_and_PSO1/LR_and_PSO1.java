...
import Input_Output_txt.Carpool.Read_LR_Lambda;
...
public class LR_and_PSO1 {
	...
	public static void main( ) throws IOException {
		...
		System.out.print("Generation: " + generationCount + " F(x,y) Fittest: "+ myPop.getFittest().getFitness() + " F1(x,y) Fittest: "+ myPop.getFittest().getFitness1());
 	...
 	//	for(int t=0;t<100;t++){
		...
		Output_Result.LR_and_PSO1(Y, X, Fittest, Fittest_Iter, T_total_time, (T_total_time-time_write_to_TXT));
		String X1="",Y1="";
		for(int i=0;i<X.length;i++)
			for(int j=0;j<X[i].length;j++)
				X1+=X[i][j]+" ";
