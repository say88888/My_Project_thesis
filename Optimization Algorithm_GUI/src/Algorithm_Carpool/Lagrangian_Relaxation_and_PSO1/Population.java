package Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1;

import Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1.E_Individual;
import Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1.G_Individual;
import Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1.Individual;
import Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1.P_Individual;
import Algorithm_Carpool.Lagrangian_Relaxation_and_PSO1.V_Individual;

public class Population extends LR_and_PSO1 {
	...
	public Population(int populationSize, boolean initialise) {
		...
		if (initialise) {
			...
			newIndividual.XsetIndividual();
			newIndividual.YsetIndividual();
			saveIndividual(0, newIndividual);
			 
			for(int i=1;i<size();i++){
				Individual newIndividual2 = new Individual();
				newIndividual2.XgenerateIndividual();
				newIndividual2.YgenerateIndividual();
