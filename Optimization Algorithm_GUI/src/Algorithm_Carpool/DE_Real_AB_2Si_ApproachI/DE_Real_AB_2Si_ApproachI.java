...
public class DE_Real_AB_2Si_ApproachI {
...
//	public static int[] s;
	...
	/*	f = new double[6];
		...
		Output_Result.DE_Real_AB_2Si_ApproachI(GY, GX, Fittest, Fittest_Iter,T_total_time, (T_total_time-time_write_to_TXT),str);
		String X1="",Y1="";
		for(int i=0;i<GX.length;i++)
			X1+=GX[i]+" ";
		for(int i=0;i<GY.length;i++)
