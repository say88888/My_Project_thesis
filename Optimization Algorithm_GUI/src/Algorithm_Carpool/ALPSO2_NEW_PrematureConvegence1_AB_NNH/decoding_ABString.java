...
public class decoding_ABString extends ALPSO2_NEW_PrematureConvegence1_AB_NNH{
	...
	//	Parameter_print();
		...
		Output_Result.ALPSO2_NEW_PrematureConvegence1_AB_NNH_decodingABString(X,Y,Bids,Bdm);
	}
