...
public class ALPSO2_NEW_PrematureConvegence1_AB_NNH {
	...
	Original_temp_variables_Global_best_Y.add(Y1);
		...
		Output_Result.ALPSO2_NEW_PrematureConvegence1_AB_NNH(GY, GX, Fittest, Fittest_Iter,T_total_time, (T_total_time-time_write_to_TXT),str);
		String X1="",Y1="";
		for(int i=0;i<GX.length;i++)
				X1+=GX[i]+" ";
		for(int i=0;i<GY.length;i++)
