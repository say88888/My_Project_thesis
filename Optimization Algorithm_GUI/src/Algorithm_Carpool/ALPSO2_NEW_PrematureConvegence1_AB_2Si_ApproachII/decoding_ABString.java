...
public class decoding_ABString extends ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachII{
	...
	//	Parameter_print();
		...
		Output_Result.ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachII_decodingABString(X,Y,Bids,Bdm);
	}
