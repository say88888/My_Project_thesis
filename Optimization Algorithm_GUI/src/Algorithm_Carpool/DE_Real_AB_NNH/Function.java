package Algorithm_Carpool.DE_Real_AB_NNH;
...
public class Function extends DE_Real_AB_NNH{
...
*/
	 static int select_strategy() {
			...
			if(Select_Algorithm_Type.equals("DE_Carpool_Real")){
			...
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy1_Real")){
				System.out.println("DE_Carpool_strategy1_Real");
				strategy = 1;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy2_Real")){
				System.out.println("DE_Carpool_strategy2_Real");
				strategy = 2;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy3_Real")){
				System.out.println("DE_Carpool_strategy3_Real");
				strategy = 3;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy4_Real")){
				System.out.println("DE_Carpool_strategy4_Real");
				strategy = 4;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy5_Real")){
				System.out.println("DE_Carpool_strategy5_Real");
				strategy = 5;
			}
			else if(Select_Algorithm_Type.equals("DE_Carpool_strategy6_Real")){
