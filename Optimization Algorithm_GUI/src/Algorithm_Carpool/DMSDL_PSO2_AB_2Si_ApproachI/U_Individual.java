...
public class U_Individual extends DMSDL_PSO2_AB_2Si_ApproachI{
    ...
    public void XglobalIndividual() {
    	...
    	for (int i = 0; i <P; i++)
    	{ 
    	Ux[i]=PSO_Read_Write_txt.random_generate_or_read2(Execution_Mode) ;
    	if(Md.get(i).size()>0){
