...
//	public static ArrayList<Double> successfulCR = new ArrayList<Double>();
	...
	public static int H,Nmin,Ninit,NFE;
	public static double Max_NFE;
	public static double [] MCR,MF;
	public static List<Double> SCR = new ArrayList<Double>();
	public static List<Double> SF = new ArrayList<Double>();
	...
	public static void main() throws IOException {
		...
		DE_Read_Write_txt.Read_L_SHADE_Parameter(); 
		...
		H=DE_Read_Write_txt.H();
		Max_NFE=DE_Read_Write_txt.Max_NFE();
		Nmin=DE_Read_Write_txt.Nmin();
		MCR=new double[H];
		MF=new double[H];
		for(int i=0;i<H;i++){
			MCR[i]=DE_Read_Write_txt.MCR();
			MF[i]=DE_Read_Write_txt.MF();
		}
		Ninit=populationSize;
	...
	//	cr= 0.5;
		...
		Output_Result.L_SHADE(GY, GX, Fittest, Fittest_Iter,T_total_time, (T_total_time-time_write_to_TXT),str);
		String X1="",Y1="";
		for(int i=0;i<GX.length;i++)
			X1+=GX[i]+" ";
		for(int i=0;i<GY.length;i++)
