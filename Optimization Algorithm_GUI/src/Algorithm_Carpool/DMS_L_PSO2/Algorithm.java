package Algorithm_Carpool.DMS_L_PSO2;

public class Algorithm extends DMS_L_PSO2 {
	...
	public static Population evolvePopulation(Population pop) {
		...
		for (int i = 0; i < pop.size(); i++) {
			...
			for (int d = 0; d < Vinvid.Vxsize(); d++) {
				Vinvid.setVx(d, w * Vinvid.getVx(d) + (c1 * r1 * (Pinvid.getPx(d) - invid.getX(d))) + c2 * r2 * (PlbestPinvid.getPx(d) - invid.getX(d)));
