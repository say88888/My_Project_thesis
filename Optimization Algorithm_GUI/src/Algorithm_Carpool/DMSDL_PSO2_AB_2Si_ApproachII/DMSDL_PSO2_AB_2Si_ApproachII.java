...
public class DMSDL_PSO2_AB_2Si_ApproachII {
	...
	public static void main() throws IOException {
		...
		if (GUI.main.getmethod() != 2) {
			...
			Output_Result.DMSDL_PSO_AB_2Si_ApproachII(GY, GX, Fittest, Fittest_Iter, T_total_time, (T_total_time - time_write_to_TXT), str);
			String X1 = "", Y1 = "";
			for (int i = 0; i < GX.length; i++)
				X1 += GX[i] + " ";
			for (int i = 0; i < GY.length; i++)
