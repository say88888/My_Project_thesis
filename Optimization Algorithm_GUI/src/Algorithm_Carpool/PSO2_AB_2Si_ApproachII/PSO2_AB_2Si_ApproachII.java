package Algorithm_Carpool.PSO2_AB_2Si_ApproachII;
...
public class PSO2_AB_2Si_ApproachII {
	...
	Original_temp_variables_Global_best_Y.add(Y1);
		...
		Output_Result.PSO2_AB_2Si_ApproachII(GY, GX, Fittest, Fittest_Iter,T_total_time, (T_total_time-time_write_to_TXT),str);
		String X1="",Y1="";
		for(int i=0;i<GX.length;i++)
				X1+=GX[i]+" ";
		for(int i=0;i<GY.length;i++)
		...
		//	for(int t=0;t<100;t++){
			...
			Output_Result.PSO2_Batch(n,GY, GX, Fittest, generationCount,T_total_time, (T_total_time-time_write_to_TXT));
			System.out.println();
