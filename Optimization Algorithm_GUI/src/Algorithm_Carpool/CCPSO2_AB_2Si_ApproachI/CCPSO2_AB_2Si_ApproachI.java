...
public class CCPSO2_AB_2Si_ApproachI {
	...
	public static void main(  ) throws IOException {
		...
		Output_Result.CCPSO2_AB_2Si_ApproachI(GY, GX, Fittest, Fittest_Iter, T_total_time, (T_total_time-time_write_to_TXT));
		String X1="",Y1="";
		for(int i=0;i<GX.length;i++)
				X1+=GX[i]+" ";
		for(int i=0;i<GY.length;i++)
		...
		//	for(int t=0;t<100;t++){
			...
			Output_Result.CCPSO2_Batch(n,GY, GX, Fittest, generationCount,T_total_time, (T_total_time-time_write_to_TXT));
			System.out.println();
