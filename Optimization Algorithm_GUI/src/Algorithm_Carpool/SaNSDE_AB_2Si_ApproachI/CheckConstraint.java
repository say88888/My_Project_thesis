...
public class CheckConstraint  extends SaNSDE_AB_2Si_ApproachI {
...
*/
	...
	&& (Omega_7*Object_Function.get_cp_p()) <= (Omega_7*(1+Epsilon4)*Object_Function.get_cp_d()))
	 ...
	 for(int p=0;p<P;p++){
		 ...
		 if (time==false) {System.out.println("False");}
	...
	//(2-19)
	 for(int p=0;p<P;p++){
		 ...
		 if (time==false) { right=false;  break;}
		 }
