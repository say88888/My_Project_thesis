...
public class FitnessCalc extends ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachI {
	...
	static double getFitness1(Individual individual) {
		...
		// U1(X,Y)
			...
			double Sfmin;
			Sfmin = ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachI.Sfmin;
	...
	static double getFitness1(Candidate_Individual individual) {
