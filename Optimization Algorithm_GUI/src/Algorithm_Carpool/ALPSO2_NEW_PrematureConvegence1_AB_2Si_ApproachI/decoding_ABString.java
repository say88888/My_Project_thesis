...
public class decoding_ABString extends ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachI{
	...
	//	Parameter_print();
		...
		Output_Result.ALPSO2_NEW_PrematureConvegence1_AB_2Si_ApproachI_decodingABString(X,Y,Bids,Bdm);
	}
