...
public class Select_multi_Algorithm_show_chart_Carpool extends Carpool implements ActionListener
{
   ...
   Select_multi_Algorithm_show_chart_Carpool()
   {
	   lst.clear();
   ...
   { 
		// TODO Auto-generated method stub
	   	new Select_multi_Algorithm_show_chart_Carpool();
   }
