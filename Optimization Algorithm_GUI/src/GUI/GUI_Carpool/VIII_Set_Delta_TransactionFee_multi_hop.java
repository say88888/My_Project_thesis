...
public class VIII_Set_Delta_TransactionFee_multi_hop implements ActionListener {
	JFrame frm = new JFrame("VIII_Set_Delta_TransactionFee_multi_hop");

	JButton btn2 = new JButton("Set_a_Delta_TransactionFee");
	JButton btn3 = new JButton("Exit");

	VIII_Set_Delta_TransactionFee_multi_hop() {
...
*/
	...
	public static void main() {
		new VIII_Set_Delta_TransactionFee_multi_hop();
	}
