...
public class Select_multi_Algorithm extends Double_Auction implements ActionListener
{
      ...
      public void actionPerformed(ActionEvent e)
   {
      ...
      public static void initialize_list(){
          ...
          lst.add("CCPSO2");
          lst_Select_Algorithm1.add("CPLEX_LP");
          lst.add("CPLEX_Vector");
          lst_Select_Algorithm1.add("TS_DA");
          lst.add("TS_DA");
          lst_Select_Algorithm1.add("DE_DA");
          lst.add("DE_DA");
          lst_Select_Algorithm1.add("DE_DA_strategy1");
          lst.add("DE_DA_strategy1");
          lst_Select_Algorithm1.add("DE_DA_strategy2");
          lst.add("DE_DA_strategy2");
          lst_Select_Algorithm1.add("DE_DA_strategy3");
          lst.add("DE_DA_strategy3");
          lst_Select_Algorithm1.add("DE_DA_strategy4");
          lst.add("DE_DA_strategy4");
          lst_Select_Algorithm1.add("DE_DA_strategy5");
          lst.add("DE_DA_strategy5");
          lst_Select_Algorithm1.add("DE_DA_strategy6");
          lst.add("DE_DA_strategy6");
          lst_Select_Algorithm1.add("PSO_TS_DA");
          lst.add("PSO_TS_DA");
          lst_Select_Algorithm1.add("Heuristic_PSO");
          lst.add("Heuristic_PSO");
          ...
          lst.add("CCPSO2_P");
          lst_Select_Algorithm1.add("PSO1_Tanh");
          lst.add("PSO1_Tanh");
          lst_Select_Algorithm1.add("PSO2_Tanh");
          lst.add("PSO2_Tanh");
          lst_Select_Algorithm1.add("ALPSO_Tanh");
          lst.add("ALPSO_Tanh");
          lst_Select_Algorithm1.add("LRPSO_Tanh");
          lst.add("LRPSO_Tanh");
          lst_Select_Algorithm1.add("LR_and_PSO2_Tanh");
          lst.add("LR_and_PSO2_Tanh");
          lst_Select_Algorithm1.add("LR_and_PSO1_Tanh");
          lst.add("LR_and_PSO1_Tanh");
          lst_Select_Algorithm1.add("CCPSO2_Tanh");
          lst.add("CCPSO2_Tanh");
          ...
          lst_Select_Algorithm1.add("DE_DA_Real");
          lst.add("DE_DA_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy1_Real");
          lst.add("DE_DA_strategy1_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy2_Real");
          lst.add("DE_DA_strategy2_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy3_Real");
          lst.add("DE_DA_strategy3_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy4_Real");
          lst.add("DE_DA_strategy4_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy5_Real");
          lst.add("DE_DA_strategy5_Real");
          lst_Select_Algorithm1.add("DE_DA_strategy6_Real");
          lst.add("DE_DA_strategy6_Real");
          ...
          lst_Select_Algorithm1.add("DE_DA_Real_Problem3");
          lst.add("DE_DA_Real_Problem3");
          lst_Select_Algorithm1.add("DE_DA_Real_POP_Problem3");
          lst.add("DE_DA_Real_POP_Problem3");
          lst_Select_Algorithm1.add("NSDE_Problem3");
          lst.add("NSDE_Problem3");
          lst_Select_Algorithm1.add("SaNSDE_Problem3");
          lst.add("SaNSDE_Problem3");
