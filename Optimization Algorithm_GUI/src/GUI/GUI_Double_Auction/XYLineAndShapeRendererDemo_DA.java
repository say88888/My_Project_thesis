...
class XYLineAndShapeRendererDemo_DA extends ApplicationFrame{  
    ...
    public XYLineAndShapeRendererDemo_DA(String s)  
    {  
        super(s);  
  ...
  //      xylineandshaperenderer.setSeriesShapesVisible(1,false);  
    ...
    {  
        XYLineAndShapeRendererDemo_DA xylineandshaperendererdemo1 = new XYLineAndShapeRendererDemo_DA("XYLineAndShapeRenderer Demo");  
    ...
    static void Read_Original_data_Excel(){
    	...
    	lst_Select_Algorithm=Select_multi_Algorithm_show_chart_DA.lst_Select_Algorithm2();
