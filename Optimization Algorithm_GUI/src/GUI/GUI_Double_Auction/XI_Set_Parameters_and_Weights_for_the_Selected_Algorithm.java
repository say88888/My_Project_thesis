...
public class XI_Set_Parameters_and_Weights_for_the_Selected_Algorithm extends Double_Auction
	...
	JButton btn4 = new JButton("Set_Omega");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(btn4)) {
			...
			Set_Omega_For_Objective_Function.main();
