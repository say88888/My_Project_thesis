...
public class Consolidation_word_Selected_Mode
	...
	public static void main( ) {
		...
		new Consolidation_word_Selected_Mode();
	}
	public void actionPerformed(ActionEvent e) {

		if (e.getSource().equals(btn1)) {
			Consolidation_word_Carpool.main();
		}
		if (e.getSource().equals(btn2)) {
			Consolidation_word_DA.main();
		}
