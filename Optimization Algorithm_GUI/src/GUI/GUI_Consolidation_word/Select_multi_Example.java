...
public class Select_multi_Example implements ActionListener
{
   ...
   JButton btn6=new JButton("initialize_list");
   
   Select_multi_Example()
   {
	   lst=new List();
	   lst_Path1.clear();
